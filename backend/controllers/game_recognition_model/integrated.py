...
import glob
import random
root = 'C:/Users/AAYUSH/OneDrive/Desktop/test_api/controllers/game_recognition_model/'
def get_title(path):
...
check = getGame([root+'tf_files/sky.jfif',root+'tf_files/gta.jfif',root+'tf_files/b4.jfif'])
#print(check)
